...
export class StartMenuScene extends Phaser.Scene {
    ...
    preload(): void {
        ...
        this.load.image('Logo', 'assets/sprites/start-menu-scene/quarantine-logo-14.png');
        // New Game Button
        this.load.image('NewGame', 'assets/sprites/start-menu-scene/new-game-button-neutral.png');
        this.load.image('NewGameH', 'assets/sprites/start-menu-scene/new-game-button-hovered.png');
        this.load.image('NewGameP', 'assets/sprites/start-menu-scene/new-game-button-pressed.png');
        // Easy Button
        this.load.image('Easy', 'assets/sprites/start-menu-scene/easy-button-neutral.png');
        this.load.image('EasyH', 'assets/sprites/start-menu-scene/easy-button-hovered.png');
        this.load.image('EasyP', 'assets/sprites/start-menu-scene/easy-button-pressed.png');
        // Normal Button
        this.load.image('Normal', 'assets/sprites/start-menu-scene/normal-button-neutral.png');
        this.load.image('NormalH', 'assets/sprites/start-menu-scene/normal-button-hovered.png');
        this.load.image('NormalP', 'assets/sprites/start-menu-scene/normal-button-pressed.png');
        // Hard Button
        this.load.image('Hard', 'assets/sprites/start-menu-scene/hard-button-neutral.png');
        this.load.image('HardH', 'assets/sprites/start-menu-scene/hard-button-hovered.png');
        this.load.image('HardP', 'assets/sprites/start-menu-scene/hard-button-pressed.png');
        // Start Button
        this.load.image('Start', 'assets/sprites/start-menu-scene/start-button-neutral.png');
        this.load.image('StartH', 'assets/sprites/start-menu-scene/start-button-hovered.png');
        this.load.image('StartP', 'assets/sprites/start-menu-scene/start-button-pressed.png');
    }
